...
//   const BACKEND_URL = `http://localhost:5000/api/navbar/${userId}/${templateId}`;
...
//     // Clear and append dynamic navbar content
...
//     // 2) Fetch CMS pages (type === 'page') and order them
...
//     // 3) Render your original navbar items
