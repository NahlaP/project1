...
// /* -----------------------------------------------------------
//    CORS (allow-list)
//    - allows your cPanel proxy + S3 bucket + localhost + dashboard
//    ----------------------------------------------------------- */

// const envFrontend = process.env.FRONTEND_ORIGIN;     // e.g. http://localhost:3000
// const envCpanelBase = process.env.CPANEL_BASE_URL;   // e.g. https://ion7devtemplate.mavsketch.com

// const rawAllowList: (RegExp | string | undefined)[] = [
//   // 🔹 Explicit dashboard domains
//   "http://ion7dashboard.mavsketch.com",
//   "https://ion7dashboard.mavsketch.com",

//   // 🔹 From env (optional)
//   envFrontend,
//   envCpanelBase,

//   // 🔹 Any *.mavsketch.com (includes ion7devtemplate.mavsketch.com etc.)
//   /^https?:\/\/([a-z0-9-]+\.)*mavsketch\.com(:\d+)?$/i,
//   /^https?:\/\/ion7devtemplate\.mavsketch\.com(:\d+)?$/i,
...
// const allowList = rawAllowList.filter(Boolean) as (RegExp | string)[];

// app.use(
//   cors({
//     origin: (origin, cb) => {
//       if (!origin) return cb(null, true); // non-browser / curl etc.
...
//     // Optional: start server even if DB fails
//     app.listen(PORT, "0.0.0.0", () => {
//       console.log(`🚀 Server listening at http://0.0.0.0:${PORT} (DB FAILED)`);
//       console.log("CORS allow-list:");
//       for (const r of allowList) console.log(" •", r.toString());
//     });
//   });
