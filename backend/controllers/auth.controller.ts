...
// const stripe = STRIPE_SECRET_KEY
//   ? new Stripe(STRIPE_SECRET_KEY, {
//       // keep same version, just cast for TS
//       apiVersion: "2024-06-20" as any,
//     })
//   : null;
...
//             id: stripeSub.id,
//             status: stripeSub.status,
//             current_period_start: subAny2?.current_period_start ?? null,
//             current_period_end: subAny2?.current_period_end ?? null,
//           }
//         : null,
//     });
//   } catch (e) {
