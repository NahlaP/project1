...
// /* --------- Auth --------- */
// api.signup = function signup(fullName, company, country, email, password) {
...
// // optional stub for saving the user's selected priceId
// api.choosePlan = async function choosePlan(priceId) {
//   try {
...
//     });
//   } catch (e) {
//     // if route is not implemented yet, surface a friendly message but don’t crash the page
