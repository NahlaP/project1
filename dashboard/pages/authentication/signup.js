...
//   // extra guard against chrome autofill
//   useEffect(() => {
//     // tiny delay to let browser attempt autofill, then clear if it did
//     const t = setTimeout(() => {
...
//       // keep React state in sync if autofill sneaked in before mount
...
//       // 🔥 FORCE redirect to /authentication/signin
...
//           autoComplete="off"
//         >
//           {/* hidden dummy fields to fully defeat autofill */}
...
//             <a href="/authentication/signin" className="link">Sign in</a>
//           </div>
//         </form>
//       </div>
...
//           box-shadow:0 24px 70px rgba(0,0,0,.12); backdrop-filter:blur(8px);
...
//         .input{
//           width:100%; background:#fff; border:2px solid var(--border-strong);
//           border-radius:12px; padding:12px 44px 12px 14px; font-size:14px; outline:none; color:#111827;
...
//           background: linear-gradient(180deg, #ff3b30, #e22e25); color:#fff; font-weight:700; letter-spacing:.2px; cursor:pointer;
//           box-shadow:0 16px 40px rgba(255,59,48,.35); transition: transform .06s ease, filter .15s ease;
//         }
