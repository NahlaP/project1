...
//   const [success, setSuccess] = useState(""); // ✅ in-page success banner
...
//       if (stayAfterSave) {
//         // ✅ keep user on the page and show success banner
//         await load();
//         setSuccess(`All of your changes to “${email}” are saved.`);
//       } else {
//         // ✅ behave like cPanel list redirect with flash
//         const flash = `Saved changes for ${email}`;
//         router.push(`/email-manager?flash=${encodeURIComponent(flash)}&flashType=success`);
//       }
//     } catch (e) {
//       setErr(e.message || String(e));
//     } finally {
...
//         style={{
//           flexGrow: 1,
//           padding: "64px 20px 24px", // extra top space so it's not under the header
...
//         {/* ✅ success banner (like cPanel) */}
//         {success && (
//           <div
//             style={{
//               background: "#eaffea",
//               border: "1px solid #8ed38e",
//               color: "#145214",
//               padding: 10,
//               borderRadius: 6,
//               margin: "0 0 14px",
...
//             marginTop: 6
//           }}>
//             {/* ✅ cPanel-like stay-after-save option */}
//             <label style={{ display: "flex", alignItems: "center", gap: 8, color: "#334" }}>
//               <input
//                 type="checkbox"
