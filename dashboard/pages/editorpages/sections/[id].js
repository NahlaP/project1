...
//     (async () => {
//       try {
//         const res = await axios.get(`http://localhost:5000/api/sections/by-id/${id}`);
//         setSection(res.data);
//       } catch (err) {
...
//   return (
//     <div className="p-4">
//       <h2>Edit Section: <span className="text-primary">{section.title}</span></h2>

//       <form
//         onSubmit={async (e) => {
//           e.preventDefault();
//           try {
//             await axios.patch(`http://localhost:5000/api/sections/${id}`, {
//               title: section.title,
//               type: section.type,
