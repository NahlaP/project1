...
//                                         router.push(`${route}?pageId=${resolvedPageId}&sectionId=${section._id}`);
//                                     }}
//                                   >
...
// import BlogPreview from "../blogE";                 // (existing)
// import ContactPreview from "../contactE";           // <-- NEW: Contact preview
...
//   faHandshake,
//   faBlog,
//   faEnvelope,                                       // <-- NEW: icon for contact
// } from "@fortawesome/free-solid-svg-icons";
...
//       { type: "contact", label: "Contact" },           // <-- NEW
//       { type: "appointment", label: "Appointment" },
//       { type: "team", label: "Team" },
//       { type: "testimonials", label: "Testimonials" },
//     ],
...
//     contact: "Get in touch with us",                    // <-- NEW
//     appointment: "Booking and contact form",
//     testimonials: "What clients say",
//     team: "Meet the people behind the brand",
//   };
...
//                                         contact: "/editorpages/contactS",        // <-- NEW: edit route
//                                         appointment: "/editorpages/appointmentS",
//                                         testimonials: "/editorpages/testimonialS",
//                                         team: "/editorpages/teamS",
//                                       };
