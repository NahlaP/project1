...
//       }}
//     >
//       {/* Left: simple swiper-ish strip preview */}
...
//                 <span className="fw-semibold">{it.alt || it.imageUrl.split("/").pop()}</span>
//                 <span className="text-muted ms-2" style={{ wordBreak:"break-all" }}>{it.href}</span>
//               </li>
//             ))}
//           </ul>
//         ) : (
//           <div className="text-muted mb-2">No brands yet.</div>
//         )}

//         <div className="d-flex align-items-center gap-3 mt-2">
//           {/* keep consistent with your other previews (button is optional) */}
