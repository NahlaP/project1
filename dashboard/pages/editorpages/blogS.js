...
//   if (u.startsWith("/")) return `${backendBaseUrl}${u}`; // relative to backend
//   return toPublicS3(u) || `${backendBaseUrl}/${u}`;      // try S3 key, else fallback
// };
...
//       throw new Error(txt || "Upload failed");
//     }
//     // Expected: { imageKey, imageUrl? } OR { result: {...} }
//     return res.json();
//   };
...
//     setErrorMsg("");
//     try {
//       const r = await fetch(`${baseUrl}/reset?_=${Date.now()}`, {
//         method: "POST",
//         headers: { Accept: "application/json" },
//         cache: "no-store",
//         credentials: "include",
