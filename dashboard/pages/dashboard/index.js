...
export default function DashboardHome() {
  ...
  // 🔴 IMPORTANT: For "View Site" and "Preview Changes"
  // we always open the public cPanel domain.
  const openPreview = () => {
    if (PUBLIC_HOST) {
      // PHP on ion7devtemplate.mavsketch.com will read ion7_site cookie
      // and redirect to the correct S3 template for this user/template.
      window.open(
      ...
      // Fallback: direct S3 preview (should rarely be used in prod)
