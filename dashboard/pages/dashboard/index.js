...
// import { Container, Row, Col, Card } from "react-bootstrap"; // <- removed Button
...
// // Same-origin axios instance → requests go to https://your-vercel-domain/...,
// // and Next.js rewrites proxy to your EC2 backend.
...
//   // inline helpers to “force” styles without touching global scss
//   const cardGlass = {
...
//     backgroundImage: `
//       radial-gradient(800px 400px at 10% 20%, rgba(255,173,173,0.45), transparent 60%),
//       radial-gradient(600px 300px at 90% 30%, rgba(255,214,165,0.45), transparent 60%),
//       radial-gradient(500px 300px at 30% 90%, rgba(202,255,191,0.45), transparent 60%),
//       radial-gradient(500px 300px at 80% 70%, rgba(213,255,64,0.35), transparent 60%),
//       radial-gradient(320px 220px at 55% 45%, rgba(155,246,255,0.35), transparent 60%)
//     `
//   };
...
//                   <button
//                     type="button"
//                     className="btn w-100 fw-medium rounded-3 button-mavsketch"
...
//                     <button
//                       type="button"
//                       className="btn fw-medium rounded-3 w-50 button-mavsketch"
//                       style={{ padding: "6px 0" }}
//                     >
//                       View Site
//                     </button>
...
//                       <button
//                         type="button"
//                         className="btn button-mavsketch"
...
//                     ) : (
//                       // RED (disabled)
//                       <button type="button" className="btn button-mavsketch" disabled>
...
//   // Glass card helper (kept minimal)
//   const cardGlass = {
//     background: "rgba(255,255,255,0.28)",
//     backdropFilter: "blur(50px)",
//     WebkitBackdropFilter: "blur(50px)",
...
//   // Put the gradient on the **outer wrapper** so it shows across the whole page,
//   // including behind the sidebar.
//   const pageBgStyle = {
//     display: "flex",
//     minHeight: "100vh",
...
//   return (
//     <>
//       {/* This makes ONLY this page clear the solid mask from #page-content. */}
//       <style jsx global>{`
...
export default function DashboardHome() {
  ...
  return (
    <>
      {/* 1) Remove the solid mask just for this page */}
      <style jsx global>{`
        #page-content { background-color: transparent !important; }
      `}</style>

      {/* 2) Render your blob background defined in _user.scss */}
      <div className="bg-wrapper-custom">
        ...
        {/* Optional soft veil from your SCSS */}
        <div className="bg-inner-custom" />
      </div>

      {/* Content wrapper sits above the bg */}
