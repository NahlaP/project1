...
//       tpl.currentTag ||
//       versions?.[0]?.tag ||
//       "v1"; // fall back to v1 if nothing present
...
//       // IMPORTANT: pass ?ver=<selectedTag> so backend pulls the correct version
...
//     } catch (e) {
//       setToast({ show: true, msg: e?.message || "Reset failed", variant: "danger" });
//     } finally {
//       setResetting(false);
//     }
//   }
...
//                         Subscribers
//                       </h6>
//                       <h3 className="fw-bold mb-1" style={{ fontSize: "2rem" }}>2,548</h3>
//                       <p className="text-muted mb-0" style={{ fontSize: "0.9rem" }}>
//                         Compared to 2,267 last month
//                       </p>
//                     </div>
...
//                         Page Views
//                       </h6>
//                       <h3 className="fw-bold mb-1" style={{ fontSize: "2rem" }}>42.5k</h3>
//                       <p className="text-muted mb-0" style={{ fontSize: "0.9rem" }}>
//                         Compared to 39.3k last month
//                       </p>
//                     </div>
...
//                         Bounce Rate
//                       </h6>
//                       <h3 className="fw-bold mb-1" style={{ fontSize: "2rem" }}>28.3%</h3>
//                       <p className="text-muted mb-0" style={{ fontSize: "0.9rem" }}>
//                         Compared to 26.2% last month
//                       </p>
//                     </div>
